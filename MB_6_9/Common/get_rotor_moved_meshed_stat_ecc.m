function [PTS_ROT,PTS_RO,PTS_AGM,ELE_AGM,KPTS_ROT] = get_rotor_moved_meshed_stat_ecc(OME_MECH,PTS_ROT,PTS_RO,PTS_SI,...
    npts_ro,npts_si,pts_ofset,KPTS_ROT,THIC_AIRGAP,ecc,TIME)
...
PTS_ROT(:, 3) = PTS_ROT(:, 3) + THIC_AIRGAP*ecc;
KPTS_ROT(:,3) = KPTS_ROT(:,3) + THIC_AIRGAP*ecc;
