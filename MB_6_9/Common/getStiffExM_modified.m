function [Kz, Jz, bz] = getStiffExM_modified(ELEMS,PTS,MYNEU,PMRF,PDirs)
...
%         J0    = CURDEN(ielem);
        ...
        [EMQ8,FQ8,bQ8] = getEMQ8_KCP_PM_rot_modified(nodeX,nodeY,muR,iprop,BR,Slot_Area,Nturn,PD_Data);
