function [PTS_ROT,PTS_RO,PTS_AGM,ELE_AGM,KPTS_ROT] = get_rotor_moved_meshed_edited(del_t,OME_MECH,PTS_ROT,PTS_RO,PTS_SI,...
...
PTS_ROT(:, 2) = PTS_ROT(:, 2) + THIC_AIRGAP*ecc;
KPTS_ROT(:,2) = KPTS_ROT(:,2) + THIC_AIRGAP*ecc;
...
PTS_RO(:,2) = PTS_RO(:,2) + THIC_AIRGAP*ecc;
[PTS_RO(:,3),PTS_RO(:,2)]    = cart2pol(PTS_RO(:,2),PTS_RO(:,3))   ;
